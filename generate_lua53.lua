...
_:lexer()
  :_ (RE[[\s+]]) :skip()
  :_ "and" :attr "operator"
  :_ "break" :attr "statement"
  :_ "do" :attr "statement"
  :_ "else" :attr "statement"
  :_ "elseif" :attr "statement"
  :_ "end" :attr "statement"
  :_ "false" :attr "constant"
  :_ "for" :attr "statement"
  :_ "function" :attr "structure"
  :_ "goto" :attr "statement"
  :_ "if" :attr "statement"
  :_ "in" :attr "statement"
  :_ "local" :attr "statement"
  :_ "nil" :attr "constant"
  :_ "not" :attr "operator"
  :_ "or" :attr "operator"
  :_ "repeat" :attr "statement"
  :_ "return" :attr "statement"
  :_ "then" :attr "statement"
  :_ "true" :attr "constant"
  :_ "until" :attr "statement"
  :_ "while" :attr "statement"
  :_ "+" :attr "operator"
  :_ "-" :attr "operator"
  :_ "*" :attr "operator"
  :_ "/" :attr "operator"
  ...
  :_ (RE[["[^\\"]*"]]) :as "LiteralString" :sub(2, -2) :attr "constant"
  :_ (RE[['[^\\']*']]) :as "LiteralString" :sub(2, -2) :attr "constant"
  :_ ("[[\n" * (RE[[.*]] - RE[[.*\]\].*]]) * "]]") :as "LiteralString" :sub(4, -3) :attr "constant"
  :_ ("[[" * (RE[[.*]] - RE[[.*\]\].*]]) * "]]") :as "LiteralString" :sub(3, -3) :attr "constant"
  ...
  :_ (RE[[(\d+(\.\d*)?|\.\d+)([eE][+-]?\d+)?]]) :as "Numeral" :attr "constant"
  :_ (RE[[0[xX]([0-9A-Fa-f]+(\.[0-9A-Fa-f]*)?|\.[0-9A-Fa-f]+)([pP][+-]?\d+)?]]) :as "Numeral" :attr "constant"
  :_ ("--[[" * (RE[[.*]] - RE[[.*\]\].*]]) * "]]") :skip()
  :_ (RE[[--\[=+\[]]) :sub(4, -2) :join("]", "]") :hold() :skip() :call "long_comment"
  :_ ("--" * (RE[[[^\n]*]] - RE[[\[=*\[.*]]) * "\n") : skip()

string_lexer(_:lexer "dq_string")
  :_ [["]] :as "LiteralString" :concat() :ret() :attr "constant"

string_lexer(_:lexer "sq_string")
  :_ [[']] :as "LiteralString" :concat() :ret() :attr "constant"

_:search_lexer "long_string"
  :when() :as "LiteralString" :concat() :ret() :attr "constant"
  :otherwise() :push()
