...
-- :_ ("--" * ((-S"\n")^"*") "\n") :skip()
  :_ (RE[[--[^\n]*\n]]) :skip()
-- :_ ([[\u]] * S"Dd" * S"89ABab" * R"09AFaf"^{2} * [[\u]] * S"Dd" * R"CFcf" * R"09AFaf"^{2}) :as "pair" :utf8_pair(3, 6, 9, 12)
  :_ (RE[[\\u[Dd][89ABab][0-9A-Fa-f]{2}\\u[Dd][C-Fc-f][0-9A-Fa-f]{2}]])  :as "pair" :utf8_pair(3, 6, 9, 12)
